		...
		var det:any=[];
		            ...
		            for (k = 0; k < this.googleapilatlong.length; k++) {
						...
						console.log(markers1);
                         // infowindow.setContent("<div style='float:left; margin-right:10px;'><img style='float:left' src="+this.googleapidata[0].icon+"></div><span style='float: left;margin-top: 6px;'>" +this.googleapidata[0].name+ "</span>")
					...
					this.markers.push(marker);
					 ...
					 google.maps.event.addListener(marker, 'click', (function (marker, k) {
                            return function () {
                               ...
                               // infowindow.setContent("<div style='float:left; margin-right:10px;'><img style='float:left' src="+this.googleapidata[k].icon+"></div><span style='float: left;margin-top: 6px;'>" +this.googleapidata[k].name+ "</span>")
